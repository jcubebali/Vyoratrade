      ...
      <div className="w-full max-w-md relative z-10">
        <div className="bg-slate-900/60 backdrop-blur-xl border border-slate-800/80 rounded-3xl p-8 shadow-2xl transition-all duration-300 relative hover:border-slate-700/60">
          ...
          <div className="flex flex-col items-center mb-6">
            <span className="text-emerald-400 font-extrabold text-3xl font-mono tracking-wider flex items-center gap-1.5">
              VYORA
            </span>
            <div className="w-12 h-0.5 bg-emerald-500/30 mt-2 rounded-full" />
          </div>
          ...
          >
            <svg className="w-4 h-4 shrink-0" viewBox="0 0 24 24">
              ...
              <path
                fill="currentColor"
                d="M12 5.38c1.62 0 3.06.56 4.21 1.64l3.15-3.15C17.45 2.09 14.97 1 12 1 7.7 1 3.99 3.47 2.18 7.07l3.66 2.84c.87-2.6 3.3-4.53 6.16-4.53s"
              />
            </svg>
